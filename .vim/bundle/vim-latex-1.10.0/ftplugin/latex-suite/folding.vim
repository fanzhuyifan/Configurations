...
function! MakeTexFolds(force, manual)
  ...
  %"proof,lemma,problem,corollary,theorem,poposition,definition,remark" added by fanzhuyifan@gmail.com 2019.01.13
  let s = 'proof,lemma,problem,corollary,theorem,poposition,definition,remark,'
